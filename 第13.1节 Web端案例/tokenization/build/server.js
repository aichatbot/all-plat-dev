...
const api = (app) => {
  app.post('/api/tokenization', async (req, res) => {
    try {
      ...
      const pyshell = new python_shell__WEBPACK_IMPORTED_MODULE_0__["PythonShell"](
        'seg.py',
        { scriptPath: '/Users/aichatbot/Google 云端硬盘/著作/MERN/all-plat-dev/Chapter 32/tokenization/src' },
      );
...
Object(_api__WEBPACK_IMPORTED_MODULE_2__["default"])(app);
